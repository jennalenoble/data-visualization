...
def test_0_2(answer):
    ...
    assert answer.shape == (1, 8), "The dimensions of your answer is incorrect. Are you filtering correctly? Do your have the correct data type? This question is looking for a dataframe object."
...
def test_3_5_2(answer):
    ...
    assert answer2.encoding.color.value == 'black', "Make sure you are coloring the points black within encoding."
    return(success)
